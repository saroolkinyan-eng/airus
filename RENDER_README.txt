...
V22 NEWS + MOBILE
-----------------
- Исправлена читаемость карточек новостей после перехода на Obsidian Champagne: тёмный текст на светлых карточках, тёплые метаданные и ссылки.
- /news/ использует аккуратную 2-колоночную сетку на desktop и одну колонку на телефонах.
- На мобильных новостях больше нет горизонтального карусельного обрезания и line-clamp: текст виден полностью.
- Улучшены узкие экраны: формы, CTA, карточки работ, контакты, страницы услуг и статьи новостей.
- CSS cache version: v22.
